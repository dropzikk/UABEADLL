...
internal sealed class GlMinVersionEntryPoint : Attribute
{
	...
	public static IntPtr GetProcAddress(Func<string, IntPtr> getProcAddress, GlInterface.GlContextInfo context, string entry, int minVersionMajor, int minVersionMinor, GlProfileType? profile = null)
	{

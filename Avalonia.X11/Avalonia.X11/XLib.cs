...
internal static class XLib
{
	...
	{
		public unsafe byte* res_name;

		public unsafe byte* res_class;
	}
	...
	[DllImport("libX11.so.6")]
	public static extern IntPtr XCreateWindow(IntPtr display, IntPtr parent, int x, int y, int width, int height, int border_width, int depth, int xclass, IntPtr visual, UIntPtr valuemask, ref XSetWindowAttributes attributes);
	...
	[DllImport("libX11.so.6")]
	public unsafe static extern IntPtr XNextEvent(IntPtr display, XEvent* xevent);
	...
	[DllImport("libX11.so.6")]
	public unsafe static extern int XFree(void* data);
	...
	{
		return XConfigureResizeWindow(display, window, size.Width, size.Height);
	}
	...
	public static uint XConfigureResizeWindow(IntPtr display, IntPtr window, int width, int height)
	{
		...
		xWindowChanges.width = width;
		xWindowChanges.height = height;
		XWindowChanges values = xWindowChanges;
		return XConfigureWindow(display, window, ChangeWindowFlags.CWWidth | ChangeWindowFlags.CWHeight, ref values);
	}
	...
	{
		IntPtr intPtr = XGetAtomName(display, atom);
	...
	[DllImport("libX11.so.6")]
	public static extern int XChangeProperty(IntPtr display, IntPtr window, IntPtr property, IntPtr type, int format, PropertyMode mode, byte[] data, int nelements);
	...
	[DllImport("libX11.so.6")]
	public unsafe static extern int XChangeProperty(IntPtr display, IntPtr window, IntPtr property, IntPtr type, int format, PropertyMode mode, void* data, int nelements);
	...
	[DllImport("libX11.so.6")]
	public static extern int XGetWindowProperty(IntPtr display, IntPtr window, IntPtr atom, IntPtr long_offset, IntPtr long_length, bool delete, IntPtr req_type, out IntPtr actual_type, out int actual_format, out IntPtr nitems, out IntPtr bytes_after, out IntPtr prop);
	...
	[DllImport("libX11.so.6")]
	public unsafe static extern bool XFilterEvent(XEvent* xevent, IntPtr window);
	...
	[DllImport("libX11.so.6")]
	public unsafe static extern int XLookupString(ref XEvent xevent, void* buffer, int num_bytes, out IntPtr keysym, out IntPtr status);

	[DllImport("libX11.so.6")]
	public unsafe static extern int Xutf8LookupString(IntPtr xic, ref XEvent xevent, void* buffer, int num_bytes, out IntPtr keysym, out IntPtr status);

	[DllImport("libX11.so.6")]
	public unsafe static extern int Xutf8LookupString(IntPtr xic, XEvent* xevent, void* buffer, int num_bytes, out IntPtr keysym, out IntPtr status);

	[DllImport("libX11.so.6")]
	public static extern IntPtr XKeycodeToKeysym(IntPtr display, int keycode, int index);
	...
	[DllImport("libX11.so.6")]
	public unsafe static extern IntPtr XGetIMValues(IntPtr xim, string name, out XIMStyles* value, IntPtr terminator);
	...
	[DllImport("libX11.so.6")]
	public static extern IntPtr XCreateIC(IntPtr xim, string name, IntPtr value, string name2, IntPtr value2, string name3, IntPtr value3, string name4, IntPtr value4, IntPtr terminator);

	[DllImport("libX11.so.6")]
	public static extern IntPtr XCreateIC(IntPtr xim, string xnClientWindow, IntPtr handle, string xnInputStyle, IntPtr value3, string xnResourceName, string optionsWmClass, string xnResourceClass, string wmClass, string xnPreeditAttributes, IntPtr list, IntPtr zero);

	[DllImport("libX11.so.6")]
	public static extern IntPtr XCreateIC(IntPtr xim, string xnClientWindow, IntPtr handle, string xnFocusWindow, IntPtr value2, string xnInputStyle, IntPtr value3, string xnResourceName, string optionsWmClass, string xnResourceClass, string wmClass, string xnPreeditAttributes, IntPtr list, IntPtr zero);
	...
	[DllImport("libX11.so.6")]
	public unsafe static extern IntPtr XVaCreateNestedList(int unused, Utf8Buffer xnArea, XRectangle* point, Utf8Buffer xnSpotLocation, XPoint* value2, Utf8Buffer xnFontSet, IntPtr fs, IntPtr zero);

	[DllImport("libX11.so.6")]
	public unsafe static extern IntPtr XVaCreateNestedList(int unused, Utf8Buffer xnSpotLocation, XPoint* value2, Utf8Buffer xnFontSet, IntPtr fs, IntPtr zero);
	...
	[DllImport("libX11.so.6")]
	public static extern bool XQueryExtension(IntPtr display, [MarshalAs(UnmanagedType.LPStr)] string name, out int majorOpcode, out int firstEvent, out int firstError);

	[DllImport("libX11.so.6")]
	public unsafe static extern bool XGetEventData(IntPtr display, void* cookie);

	[DllImport("libX11.so.6")]
	public unsafe static extern void XFreeEventData(IntPtr display, void* cookie);

	[DllImport("libXrandr.so.2")]
	public static extern int XRRQueryExtension(IntPtr dpy, out int event_base_return, out int error_base_return);
	...
	[DllImport("libXrandr.so.2")]
	public static extern int XRRQueryVersion(IntPtr dpy, out int major_version_return, out int minor_version_return);

	[DllImport("libXrandr.so.2")]
	public unsafe static extern XRRMonitorInfo* XRRGetMonitors(IntPtr dpy, IntPtr window, bool get_active, out int nmonitors);
	...
	{
		return (((byte*)ptr)[shift >> 3] & (1 << (shift & 7))) != 0;
	}

	[DllImport("libXi.so.6")]
	public unsafe static extern Status XISelectEvents(IntPtr dpy, IntPtr win, XIEventMask* masks, int num_masks);

	public unsafe static Status XiSelectEvents(IntPtr display, IntPtr window, Dictionary<int, List<XiEventType>> devices)
	{
		int* ptr = stackalloc int[devices.Count];
		XIEventMask* ptr2 = stackalloc XIEventMask[devices.Count];
		int num = 0;
		foreach (KeyValuePair<int, List<XiEventType>> device in devices)
		{
			foreach (XiEventType item in device.Value)
			{
				XISetMask(ref ptr[num], item);
			}
			ptr2[num] = new XIEventMask
			{
				Mask = ptr + num,
				Deviceid = device.Key,
		...
		return XISelectEvents(display, window, ptr2, devices.Count);
	}

	[DllImport("libX11.so.6")]
	public unsafe static extern XClassHint* XAllocClassHint();

	[DllImport("libX11.so.6")]
	public unsafe static extern int XSetClassHint(IntPtr display, IntPtr window, XClassHint* class_hints);

	public static bool XGetGeometry(IntPtr display, IntPtr window, out XGeometry geo)
	{
		geo = default(XGeometry);
		return XGetGeometry(display, window, out geo.root, out geo.x, out geo.y, out geo.width, out geo.height, out geo.bw, out geo.d);
	}
	...
	{
		QueryPointer(x11.Display, handle ?? x11.RootWindow, out var _, out var _, out var root_x, out var root_y, out var child_x, out var child_y, out var _);
		if (handle.HasValue)
		{
	...
	{
		IntPtr intPtr = XCreateSimpleWindow(plat.Display, plat.Info.DefaultRootWindow, 0, 0, 1, 1, 0, IntPtr.Zero, IntPtr.Zero);
		plat.Windows[intPtr] = handler;
		return intPtr;
	}
}

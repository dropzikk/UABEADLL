...
internal class ResourceSetterViewModel : SetterViewModel
{
	...
	public ResourceSetterViewModel(AvaloniaProperty property, object resourceKey, object? resourceValue, bool isDynamic, IClipboard? clipboard)
		: base(property, resourceValue, clipboard)
	{
		Key = resourceKey;

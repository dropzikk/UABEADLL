...
public class CubicBezierEasing : IEasing
{
	...
	internal static IEasing Ease { get; } = new CubicBezierEasing(new Point(0.25, 0.1), new Point(0.25, 1.0));

	internal CubicBezierEasing(Point controlPoint1, Point controlPoint2)
	{
		ControlPoint1 = controlPoint1;
		ControlPoint2 = controlPoint2;
		if (controlPoint1.X < 0.0 || controlPoint1.X > 1.0 || controlPoint2.X < 0.0 || controlPoint2.X > 1.0)
		{

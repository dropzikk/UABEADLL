...
internal struct ExpressionVariant
{
	...
	public ExpressionVariant GetProperty(string property)
	{
		...
		if (Type == VariantType.Vector3)
		{
			...
			if ((object)property == "Z")
			{
				return Vector3.Z;
			}
			if ((object)property == "XY")
			{
				return new Vector2(Vector3.X, Vector3.Y);
			}
			if ((object)property == "YX")
			{
				return new Vector2(Vector3.Y, Vector3.X);
			}
			if ((object)property == "XZ")
			{
				return new Vector2(Vector3.X, Vector3.Z);
			}
			if ((object)property == "ZX")
			{
				return new Vector2(Vector3.Z, Vector3.X);
			}
			if ((object)property == "YZ")
			{
				return new Vector2(Vector3.Y, Vector3.Z);
			}
			if ((object)property == "ZY")
			{
		...
		{
			if ((object)property == "M11")
			{
				return Matrix3x2.M11;
			}
			if ((object)property == "M12")
			{
				return Matrix3x2.M12;
			}
			if ((object)property == "M21")
			{
				return Matrix3x2.M21;
			}
			if ((object)property == "M22")
			{
				return Matrix3x2.M22;
			}
			if ((object)property == "M31")
			{
				return Matrix3x2.M31;
			}
			if ((object)property == "M32")
			{
		...
		if (Type == VariantType.Matrix4x4)
		{
			...
			if ((object)property == "M34")
			{
				return Matrix4x4.M34;
			}
			if ((object)property == "M41")
			{
				return Matrix4x4.M41;
			}
			if ((object)property == "M42")
			{
				return Matrix4x4.M42;
			}
			if ((object)property == "M43")
			{
				return Matrix4x4.M43;
			}
			if ((object)property == "M44")
			{
		...
		{
			if ((object)property == "A")
			{
				return (int)Color.A;
			}
			if ((object)property == "R")
			{
				return (int)Color.R;
			}
			if ((object)property == "G")
			{
				return (int)Color.G;
			}
			if ((object)property == "B")
			{
				return (int)Color.B;
			}
			return default(ExpressionVariant);
	...
	{
		ExpressionVariant result = default(ExpressionVariant);
	...
	{
		ExpressionVariant result = default(ExpressionVariant);
		result.Type = VariantType.Scalar;
	...
	{
		ExpressionVariant result = default(ExpressionVariant);
		result.Type = VariantType.Double;
		result.Double = d;
		return result;
	}
	...
	{
		ExpressionVariant result = default(ExpressionVariant);
		result.Type = VariantType.Vector2;
	...
	{
		ExpressionVariant result = default(ExpressionVariant);
		result.Type = VariantType.Vector;
		result.Vector = value;
		return result;
	}
	...
	{
		ExpressionVariant result = default(ExpressionVariant);
		result.Type = VariantType.Vector3;
	...
	{
		ExpressionVariant result = default(ExpressionVariant);
		result.Type = VariantType.Vector3D;
		result.Vector3D = value;
		return result;
	}
	...
	{
		ExpressionVariant result = default(ExpressionVariant);
		result.Type = VariantType.Vector4;
	...
	{
		ExpressionVariant result = default(ExpressionVariant);
		result.Type = VariantType.Matrix3x2;
		result.Matrix3x2 = value;
		return result;
	}
	...
	{
		ExpressionVariant result = default(ExpressionVariant);
		result.Type = VariantType.Matrix4x4;
		result.Matrix4x4 = value;
		return result;
	}
	...
	{
		ExpressionVariant result = default(ExpressionVariant);
		result.Type = VariantType.Quaternion;
		result.Quaternion = value;
		return result;
	}

	public static implicit operator ExpressionVariant(Color value)
	{
		ExpressionVariant result = default(ExpressionVariant);
		result.Type = VariantType.Color;
		result.Color = value;
		return result;
	}
	...
	public static ExpressionVariant operator -(ExpressionVariant left)
	{
		if (left.Type == VariantType.Scalar)
		{
			return 0f - left.Scalar;
		}
		if (left.Type == VariantType.Double)
		{
			return 0.0 - left.Double;
		}
		if (left.Type == VariantType.Vector2)
		{
			return -left.Vector2;
	...
	public static ExpressionVariant operator /(ExpressionVariant left, ExpressionVariant right)
	{
		...
		if (left.Type == VariantType.Vector3D && right.Type == VariantType.Scalar)
		{
			return Vector3D.Divide(left.Vector3D, right.Scalar);
		}
		if (left.Type == VariantType.Vector3D && right.Type == VariantType.Double)
		{
			return Vector3D.Divide(left.Vector3D, right.Double);
		}
		if (left.Type == VariantType.Vector4 && right.Type == VariantType.Vector4)
		{
			return left.Vector4 / right.Vector4;
	...
	{
		ExpressionVariant expressionVariant = EqualsTo(right);
		if (expressionVariant.Type == VariantType.Boolean)
		{
			return !expressionVariant.Boolean;
		}
		return default(ExpressionVariant);
	}
	...
	public bool TryCast<T>(out T res) where T : struct
	{
		...
		if (typeof(T) == typeof(Vector4) && Type == VariantType.Vector4)
		{
			res = (T)(object)Vector4;
			return true;
		}
		if (typeof(T) == typeof(Matrix3x2) && Type == VariantType.Matrix3x2)
		{
			res = (T)(object)Matrix3x2;
			return true;
		}
		if (typeof(T) == typeof(Matrix) && Type == VariantType.AvaloniaMatrix)
		{
			res = (T)(object)Matrix3x2;
			return true;
		}
		if (typeof(T) == typeof(Matrix4x4) && Type == VariantType.Matrix4x4)
		{
			res = (T)(object)Matrix4x4;
			return true;
		}
		if (typeof(T) == typeof(Quaternion) && Type == VariantType.Quaternion)
		{
			res = (T)(object)Quaternion;
			return true;
		}
		if (typeof(T) == typeof(Color) && Type == VariantType.Color)
		{
			res = (T)(object)Color;
			return true;
		}

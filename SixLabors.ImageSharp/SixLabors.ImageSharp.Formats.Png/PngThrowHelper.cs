...
internal static class PngThrowHelper
{
	...
	{
		throw new InvalidImageContentException("PNG Image must contain a header chunk and it must be located before any other chunks.");
	}

	[DoesNotReturn]
	public static void ThrowNoData()
	{
		throw new InvalidImageContentException("PNG Image does not contain a data chunk.");
	}

	[DoesNotReturn]
	public static void ThrowMissingDefaultData()
	{
		throw new InvalidImageContentException("APNG Image does not contain a default data chunk.");
	}

	[DoesNotReturn]
	public static void ThrowInvalidAnimationControl()
	{
		throw new InvalidImageContentException("APNG Image must contain a acTL chunk and it must be located before any IDAT and fdAT chunks.");
	}

	[DoesNotReturn]
	public static void ThrowMissingFrameControl()
	{
		throw new InvalidImageContentException("One of APNG Image's frames do not have a frame control chunk.");
	}

	[DoesNotReturn]
	public static void ThrowMissingPalette()
	{
		throw new InvalidImageContentException("PNG Image does not contain a palette chunk.");
	}

	[DoesNotReturn]
	public static void ThrowInvalidChunkType()
	{
		throw new InvalidImageContentException("Invalid PNG data.");
	}
	...
	{
		throw new InvalidImageContentException("CRC Error. PNG " + chunkTypeName + " chunk is corrupt!");
	}
	...
	[DoesNotReturn]
	public static void ThrowInvalidParameter(object value1, object value2, string message, [CallerArgumentExpression("value1")] string name1 = "", [CallerArgumentExpression("value1")] string name2 = "")
	{
	...
	{
		throw new InvalidImageContentException("Unknown filter type.");
	}
}

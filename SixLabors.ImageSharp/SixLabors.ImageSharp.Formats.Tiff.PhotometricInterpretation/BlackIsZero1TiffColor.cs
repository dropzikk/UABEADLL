	...
	public override void Decode(ReadOnlySpan<byte> data, Buffer2D<TPixel> pixels, int left, int top, int width, int height)
	{
		...
		for (nuint num2 = (uint)top; num2 < (uint)(top + height); num2++)
		{
			...
			for (nuint num3 = (uint)left; num3 < (uint)(left + width); num3 += 8)
			{
				...
				{
					int num5 = (b >> 7) & 1;
					Unsafe.Add(ref reference2, num3) = ((num5 == 0) ? val : val2);
					num5 = (b >> 6) & 1;
					Unsafe.Add(ref reference2, num3 + 1) = ((num5 == 0) ? val : val2);
					num5 = (b >> 5) & 1;
					Unsafe.Add(ref reference2, num3 + 2) = ((num5 == 0) ? val : val2);
					num5 = (b >> 4) & 1;
					Unsafe.Add(ref reference2, num3 + 3) = ((num5 == 0) ? val : val2);
					num5 = (b >> 3) & 1;
					Unsafe.Add(ref reference2, num3 + 4) = ((num5 == 0) ? val : val2);
					num5 = (b >> 2) & 1;
					Unsafe.Add(ref reference2, num3 + 5) = ((num5 == 0) ? val : val2);
					num5 = (b >> 1) & 1;
					Unsafe.Add(ref reference2, num3 + 6) = ((num5 == 0) ? val : val2);
					num5 = b & 1;
					Unsafe.Add(ref reference2, num3 + 7) = ((num5 == 0) ? val : val2);
				}
				else
				{
					for (nuint num6 = 0u; num6 < num4; num6++)
					{
						...
						Unsafe.Add(ref reference2, num3 + num6) = ((num7 == 0) ? val : val2);
					}
				}
			}
		}

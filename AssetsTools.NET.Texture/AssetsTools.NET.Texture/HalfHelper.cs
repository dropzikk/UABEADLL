...
public static class HalfHelper
{
	...
	{
		uint num = MantissaTable[OffsetTable[half >> 10] + (half & 0x3FF)] + ExponentTable[half >> 10];
		ConversionBuffer[0] = (byte)num;
		ConversionBuffer[1] = (byte)(num >> 8);
		ConversionBuffer[2] = (byte)(num >> 16);
		ConversionBuffer[3] = (byte)(num >> 24);

...
public class GRContextOptions
{
	...
	internal GRContextOptionsNative ToNative()
	{
		...
		result.fAllowPathMaskCaching = (byte)(AllowPathMaskCaching ? 1 : 0);
		result.fAvoidStencilBuffers = (byte)(AvoidStencilBuffers ? 1 : 0);
		result.fBufferMapThreshold = BufferMapThreshold;
		result.fDoManualMipmapping = (byte)(DoManualMipmapping ? 1 : 0);

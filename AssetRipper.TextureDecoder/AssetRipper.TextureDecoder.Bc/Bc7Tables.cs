...
{
	internal static byte[][] bcdec_bc7_actual_bits_count = new byte[2][]
	{
		new byte[8] { 4, 6, 5, 7, 5, 7, 7, 5 },
		new byte[8] { 0, 0, 0, 0, 6, 8, 7, 5 }
	};

	internal static byte[][][][] bcdec_bc7_partition_sets = new byte[2][][][]
	{
		new byte[64][][]
		{
			new byte[4][]
	...
	internal static int[] AWeight2 = new int[4] { 0, 21, 43, 64 };
	...
	internal const byte bcdec_bc7_sModeHasPBits = 203;
}
